...
cd /tmp
curl -O -k https://$server/bits/post_install_scripts/post_install_ansible.sh
bash /tmp/post_install_ansible.sh $server_class $vault_pass $switchname $switchinterface
