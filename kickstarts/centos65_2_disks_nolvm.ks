## kickstart for centos6.6 2 disk NO LVM server
...
part / --fstype=ext4 --grow --size=1 --asprimary --ondisk=sda
part swap --grow --maxsize=2016 --size=2016 --asprimary --ondisk=sda
part /data --fstype=ext4 --grow --size=1 --asprimary --ondisk=sdb
...
echo "Created with ntos65_2_disks_nolvm.ks" /root/build.manifest
