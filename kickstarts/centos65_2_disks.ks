## kickstart for centos6.6 2 disk LVM server
## jbarnett@tableausoftware.com @ `06/27/2014 01:09`
# Install options
install
text
url --url=$tree
lang en_US.UTF-8
keyboard us
#network --onboot=yes --device=eth0 --mtu=1500  --noipv6 --bootproto=static --ip=10.17.130.11 --netmask=255.255.254.0 --gateway=10.17.130.1 --nameserver 10.18.160.30,10.18.160.31 --hostname=dvjira002.tsi.lan
...
echo "Created with centos65_2_disks.ks" >> /root/build.manifest
