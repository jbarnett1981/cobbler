# kickstart for gitlab server
## jbarnett@tableausoftware.com @ 03/10/16
...
lang en_US.UTF-8
keyboard us
#network --onboot=yes --device=eth0 --mtu=1500  --noipv6 --bootproto=static --ip=10.19.129.16 --netmask=255.255.254.0 --gateway=10.19.128.1 --nameserver 10.18.160.30,10.18.160.31 --hostname=dvgitlv001.tsi.lan
...
logvol /gitlab-data --fstype=ext4 --name=lv_gitlabdata --vgname=vg01 --grow --size=1
