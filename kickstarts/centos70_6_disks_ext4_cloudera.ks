...
clearpart --initlabel --drives=sda,sdb,sdc,sdd,sde,sdf,sdg --all
#clearpart --initlabel --drives=sda,sdb,sdc,sdd,sde,sdf --all
zerombr
...
part /data/01 --fstype=ext4 --size=1 --grow --ondisk=sdb
part /data/02 --fstype=ext4 --size=1 --grow --ondisk=sdc
part /data/03 --fstype=ext4 --size=1 --grow --ondisk=sdd
part /data/04 --fstype=ext4 --size=1 --grow --ondisk=sde
part /data/05 --fstype=ext4 --size=1 --grow --ondisk=sdf
part /data/06 --fstype=ext4 --size=1 --grow --ondisk=sdg
